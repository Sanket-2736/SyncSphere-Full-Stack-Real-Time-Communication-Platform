...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        // In-memory broker for topics and user-specific queues
    ...
    /**
     * Intercept CONNECT frames to authenticate via JWT passed in the
     * STOMP "Authorization" header (value: "Bearer <token>").
     */
    @Override
